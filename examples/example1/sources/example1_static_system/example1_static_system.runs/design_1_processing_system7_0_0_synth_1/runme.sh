...
HD_PWD='/media/storage/Work/Vivado/Proyectos/mis_proyectos/IMPRESS_test/example/example1/sources/example1_static_system/example1_static_system.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
