...
HD_PWD='/media/storage/Work/Vivado/Proyectos/mis_proyectos/IMPRESS_test/example/example1/sources/example1_static_system/example1_static_system.runs/design_1_black_box_operation_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_black_box_operation_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_black_box_operation_0_0.tcl
